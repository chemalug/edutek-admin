    ...
    <nav className="navbar-main navbar-color nav-collapsible sideNav-lock gradient-45deg-purple-deep-orange">
      <div className="nav-wrapper">
        <div className="header-search-wrapper hide-on-med-and-down"><i className="material-icons">search</i>
          <input className="header-search-input z-depth-2" type="text" name="Search" placeholder="Explora Edutek" data-search="template-list" />
        ...
        <ul className="navbar-list right">
          ...
          <li><a className="dropdown-trigger waves-effect waves-block waves-light profile-button" href="#!" data-target="profile-dropdown"><span className="avatar-status avatar-online"><img src={require("assets/images/avatar/avatar-7.png")} alt="avatar" /><i /></span></a></li>
        </ul>
        ...
        <ul className="dropdown-content" id="profile-dropdown">
          ...
          <li><a className="grey-text text-darken-1" href="#!" onClick={logout}><i className="material-icons">keyboard_tab</i> Logout</a></li>
        </ul>
      </div>
